      ...
      <ScrollView>
        <View style={Style.Container}>
          <View style={Style.MinViewContent}>
            <Lottie
              Lottiewidthstyle={ChatTabStyles.LootieChat}
              source={images.Call_Animation}
            />
            <FlatList
              data={ChatList}
      ...
      <View style={ChatTabStyles.PostionAbsoluteBottom}>
        <View style={ChatTabStyles.BothFlexView}>
          <View style={ChatTabStyles.FlexRowTextStyle}>
            ...
            <View>
              <Text style={ChatTabStyles.DailyPasstextStyle}>
                {t('Astromall_Title_21')}
              </Text>
              <Text style={ChatTabStyles.DailyPasstextStyleTwo}>
                {t('Home_Title_51')}
              </Text>
            </View>
          </View>
          <View style={ChatTabStyles.ButtonViewWidth30}>
            <Button
              onPress={() => navigation.navigate(RouteName.BUY_MEBERSHIP)}
              title={t('Astromall_Title_28')}
            />
          </View>
        </View>
      </View>
