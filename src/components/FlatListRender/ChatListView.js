...
import { RatingScreen, Spacing, VectorIcon, Button, AstrologersView, LinearGradient } from '../../components';
...
const ChatListView = (props) => {
    ...
    const Astrologersdata = [
        {
            "id": 1,
            "text": 'Home_Title_12',
            "imageseye": images.ChatListiView_4,
            "Priceset": 'Home_Title_52',
        },
        {
            "id": 2,
            "text": 'Daily_Horoscope_7',
            "imageseye": images.ChatListiView_5,
            "Priceset": 'Home_Title_53',
        },
        {
            "id": 3,
            "text": 'Home_Title_10',
            "imageseye": images.ChatListiView_6,
            "Priceset": 'Home_Title_54',
        },
        {
            "id": 4,
            "text": 'Home_Title_9',
            "imageseye": images.ChatListiView_7,
            "Priceset": 'Home_Title_55',
        },
        {
            "id": 5,
            "text": 'Daily_Horoscope_4',
            "imageseye": images.ChatListiView_8,
            "Priceset": 'Home_Title_56',
        },
        {
            "id": 6,
            "text": 'Home_Title_7',
            "imageseye": images.ChatListiView_3,
            "IconName": 'videocam',
        ...
        },
        {
            "id": 7,
            "text": 'Home_Title_6',
            "imageseye": images.ChatListiView_2,
            "Priceset": 'Home_Title_58',
        },
        {
            "id": 8,
            "text": 'Home_Title_5',
            "imageseye": images.ChatListiView_1,
    ...
    return (
        <View>
            {index === 2 ?
                <View>
                    <Text style={HomeTabStyles.LiveAstrologyText}>{t("Home_Title_60")}</Text>
                    <Spacing space={SH(10)} />
                    <FlatList
                        data={Astrologersdata}
                        horizontal
                        showsHorizontalScrollIndicator={false}
                        renderItem={({ item }) => (<AstrologersView
                            item={item}
                            title={t("Call_Title_1")}
                            onPress={() => onPress()}
                        />)}
                ...
                <View style={ChatTabStyles.FlexDirectionRow}>
                    {index === 0 || index === 2 || index === 3 || index === 5 || index === 7 || index === 8 ?
                        <View style={ChatTabStyles.PostionAbsolute}>
                            <Text style={ChatTabStyles.TextCebnter}>{t("Home_Title_32")}</Text>
                        </View>
                        : null}
                    <View style={ChatTabStyles.ImageViewWidth}>
                        ...
                        {index === 1 || index === 4 || index === 9 ?
                            <Text style={ChatTabStyles.ImageBottomText}>{t("Call_Title_2")}</Text>
                            : null}
                    </View>
                    <View style={ChatTabStyles.TextViewWidth}>
                        <View style={ChatTabStyles.FlexRowSpace}>
                            ...
                            <VectorIcon icon="MaterialCommunityIcons" name="check-decagram" color={Colors.blue_color} size={SF(35)} />
                        </View>
                        ...
                        <View style={ChatTabStyles.FlexRowSpace}>
                            <View>
                                ...
                                <Text style={ChatTabStyles.SmallTextStyleTwo}>{t(item.Minutes)}</Text>
                            </View>
                            {index === 1 || index === 3 || index === 4 || index === 8 ?
                                <View>
                                    <Button buttonTextStyle={ChatTabStyles.ButtonTextStyleRed} onPress={() => onPress()} buttonStyle={ChatTabStyles.ButtonStyleRed} title={t("Call_Title_1")} />
                                    <Spacing space={SH(5)} />
                                    <Text style={ChatTabStyles.WaitTextStyle}>{t(item.Waittime)}</Text>
                                </View>
                                : <View>
                                    <Button buttonTextStyle={ChatTabStyles.ButtonTextStyle} onPress={() => onPress()} buttonStyle={ChatTabStyles.ButtonStyle} title={t("Call_Title_1")} />
                                    <Spacing space={SH(5)} />
