...
const ChatTabView = props => {
  ...
  return (
    <TouchableOpacity
      onPress={() => onPress()}
      style={
        chatCategory === item.text
          ? ChatTabStyles.HomeSelectProparty
          : ChatTabStyles.HomeSelectPropartytwo
      }>
      ...
      {index === 1 ? (
        <Image
          ...
          style={ChatTabStyles.ImageStyleDiscount}
        />
      ) : null}
      <Text
        style={
          chatCategory === item.text
            ? ChatTabStyles.HomeSelectPropartyTYext
            : ChatTabStyles.HomeSelectPropartyTYexttwo
        }>
        {t(item.text)}
      </Text>
    </TouchableOpacity>
