                    ...
                    <View style={ChatTabStyles.TextViewWidth}>
                        ...
                        <View style={ChatTabStyles.FlexRowSpace}>
                            ...
                            {index === 1 || index === 3 || index === 4 || index === 8 ?
                                <View>
                                    <Button buttonTextStyle={ChatTabStyles.ButtonTextStyleRed} buttonStyle={ChatTabStyles.ButtonStyleRed} onPress={() => onPress()} title={t("Home_Title_26")} />
                                    <Spacing space={SH(5)} />
                                    <Text style={ChatTabStyles.WaitTextStyle}>{t(item.Waittime)}</Text>
                                </View>
                                : <View>
                                    <Button buttonTextStyle={ChatTabStyles.ButtonTextStyle} buttonStyle={ChatTabStyles.ButtonStyle} onPress={() => onPress()} title={t("Home_Title_26")} />
                                    <Spacing space={SH(5)} />
